...
Actually, as Tur\'{a}n and Mantel's Theorem states, this is also the upper bound.

\section{Tur\'{a}n and Mantel's Theorem}

\begin{definition}[Tur\'{a}n's Number]
	Let $n\ge 3$. The \textbf{Tur\'{a}n's number} $T(n) = \max\{|E(G)|: |V(G)|=n\text{ and }G\text{ does not contain a }K_3\text{ subgraph}\}$.
\end{definition}

\begin{theorem}[Tur\'{a}n and Mantel's Theorem]
